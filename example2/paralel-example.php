...
require_once("SingletonFactoryExample.php");
...
// ConnectionFactory::getFactory()->getConnection("localhost","test","test","test");
// $lastId=ConnectionFactory::getFactory()->insert("users",$user);
// var_dump($lastId);
